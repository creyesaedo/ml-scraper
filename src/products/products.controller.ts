...
/**
 * Product API (/products). Exposes paginated/filterable listing plus catalog
 * search and per-product price history. Query params arrive as strings, so they
 * are parsed and clamped to safe ranges here before reaching the service.
 */
@Controller('products')
